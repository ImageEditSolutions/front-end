    ...
    <>
      <section className="text-white mx-40">
        ...
        <div className={`${isInputFilled ? 'h-[286px]' : 'h-[73px]'} bg-gray-800 rounded-lg flex justify-between w-auto px-5 mb-[23px] flex-initial`}>
          ...
          <textarea onChange={handleChange} className="flex-1 h-[73px] w-max bg-gray-800 resize-none py-[22px] mx-[27px] outline-0" placeholder="떠오른 영감을 자유롭게 작성해주세요."></textarea>
          <button className="flex-initial text-neutral-950 bg-blue-200 rounded-2xl min-w-48 w-1/6 h-[50px] px-7 py-3 my-auto">
            이미지 생성하기
